...
TRANSLATIONS.es = {
        ...
        settingAlertsMinimized: 'Mostrar siempre las alertas meteorológicas minimizadas',
        ...
        appSectionTitle: 'Una app del tiempo sin anuncios',
        appSectionBody: 'No hay nada que descargar. Añade NoAdsWeather a tu pantalla de inicio y se abrirá a pantalla completa con su propio icono: sin barra del navegador, sin tienda de aplicaciones, sin cuenta. Es el mismo sitio, así que sigue sin anuncios y sin rastreo.',
        appIosTitle: 'En iPhone o iPad',
        appIosStep1: 'Toca Compartir (el cuadrado con la flecha)',
        appIosStep2: 'Toca «Añadir a pantalla de inicio»',
        appIosStep3: 'Toca Añadir',
        appAndroidTitle: 'En Android',
        appAndroidStep1: 'Toca el menú ⋮ en Chrome',
        appAndroidStep2: 'Toca «Añadir a pantalla principal»',
        appAndroidStep3: 'Toca Añadir',
        appSectionNote: 'Elige tu ciudad una vez y se abrirá siempre en ella.',
        ...
        share5Day: 'Pronóstico de 5 días',
        share7Day: 'Pronóstico de 7 días',
        shareIncludeCurrent: 'Incluir condiciones actuales',
        shareIncludePollen: 'Incluir polen',
        shareEmoji: 'Añadir una reacción',
        shareEmojiNone: 'Ninguna',
        shareCreate: 'Crear imagen',
        shareShareBtn: 'Compartir',
        shareDownload: 'Descargar',
        shareCopyLink: 'Copiar enlace',
        shareLinkCopied: '¡Copiado!',
        shareGenerating: 'Creando imagen...',
        shareFailed: 'No se pudo crear la imagen',
        shareShareFailed: 'No se pudo compartir la imagen',
        shareCopyFailed: 'No se pudo copiar el enlace',
        settingShareBtn: 'Mostrar botón de compartir',
