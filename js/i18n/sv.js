...
TRANSLATIONS.sv = {
        ...
        appSectionTitle: 'En väderapp utan reklam',
        appSectionBody: 'Inget att ladda ner. Lägg till NoAdsWeather på hemskärmen så öppnas den i helskärm med en egen ikon – utan webbläsarfält, utan appbutik, utan konto. Det är samma sida, så fortfarande utan reklam och utan spårning.',
        appIosTitle: 'På iPhone eller iPad',
        appIosStep1: 'Tryck på Dela (fyrkanten med pilen)',
        appIosStep2: 'Tryck på ”Lägg till på hemskärmen”',
        appIosStep3: 'Tryck på Lägg till',
        appAndroidTitle: 'På Android',
        appAndroidStep1: 'Tryck på menyn ⋮ i Chrome',
        appAndroidStep2: 'Tryck på ”Lägg till på startskärmen”',
        appAndroidStep3: 'Tryck på Lägg till',
        appSectionNote: 'Välj din stad en gång så öppnas den varje gång.',
        ...
        // Share card
        share: 'Dela',
        shareTitle: 'Dela prognos',
        share5Day: '5-dagarsprognos',
        share7Day: '7-dagarsprognos',
        shareIncludeCurrent: 'Inkludera aktuella förhållanden',
        shareIncludePollen: 'Inkludera pollen',
        shareEmoji: 'Lägg till en reaktion',
        shareEmojiNone: 'Ingen',
        shareCreate: 'Skapa bild',
        shareShareBtn: 'Dela',
        shareDownload: 'Ladda ner',
        shareCopyLink: 'Kopiera länk',
        shareLinkCopied: 'Kopierad!',
        shareGenerating: 'Skapar bild...',
        shareFailed: 'Det gick inte att skapa bilden',
        shareShareFailed: 'Det gick inte att dela bilden',
        shareCopyFailed: 'Det gick inte att kopiera länken',
        settingShareBtn: 'Visa delningsknapp',
