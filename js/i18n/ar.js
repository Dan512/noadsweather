...
TRANSLATIONS.ar = {
        ...
        appSectionTitle: 'تطبيق طقس بلا إعلانات',
        appSectionBody: 'لا شيء للتنزيل. أضف NoAdsWeather إلى الشاشة الرئيسية ليفتح بملء الشاشة بأيقونته الخاصة — بلا شريط متصفح، وبلا متجر تطبيقات، وبلا حساب. إنه الموقع نفسه، لذا يبقى بلا إعلانات وبلا تتبع.',
        appIosTitle: 'على iPhone أو iPad',
        appIosStep1: 'اضغط على «مشاركة» (المربع الذي يحمل سهمًا)',
        appIosStep2: 'اضغط على «إضافة إلى الشاشة الرئيسية»',
        appIosStep3: 'اضغط على «إضافة»',
        appAndroidTitle: 'على Android',
        appAndroidStep1: 'اضغط على قائمة ⋮ في Chrome',
        appAndroidStep2: 'اضغط على «إضافة إلى الشاشة الرئيسية»',
        appAndroidStep3: 'اضغط على «إضافة»',
        appSectionNote: 'اختر مدينتك مرة واحدة وستفتح عليها في كل مرة.',
        ...
        // Share card
        share: 'مشاركة',
        shareTitle: 'مشاركة التوقعات',
        share5Day: 'توقعات 5 أيام',
        share7Day: 'توقعات 7 أيام',
        shareIncludeCurrent: 'تضمين الأحوال الحالية',
        shareIncludePollen: 'تضمين حبوب اللقاح',
        shareEmoji: 'إضافة تفاعل',
        shareEmojiNone: 'بلا',
        shareCreate: 'إنشاء صورة',
        shareShareBtn: 'مشاركة',
        shareDownload: 'تنزيل',
        shareCopyLink: 'نسخ الرابط',
        shareLinkCopied: 'تم النسخ!',
        shareGenerating: 'جاري إنشاء الصورة...',
        shareFailed: 'تعذر إنشاء الصورة',
        shareShareFailed: 'تعذر مشاركة الصورة',
        shareCopyFailed: 'تعذر نسخ الرابط',
        settingShareBtn: 'عرض زر المشاركة',
