...
TRANSLATIONS.ko = {
        ...
        cities: '도시',
        popularCities: '인기 도시',
        appSectionTitle: '광고 없는 날씨 앱',
        appSectionBody: '내려받을 것이 없습니다. NoAdsWeather를 홈 화면에 추가하면 자체 아이콘으로 전체 화면에서 열립니다. 브라우저 주소창도, 앱 스토어도, 계정도 필요 없습니다. 같은 사이트이므로 여전히 광고도 추적도 없습니다.',
        appIosTitle: 'iPhone 또는 iPad',
        appIosStep1: '공유 버튼(화살표가 있는 사각형)을 탭하세요',
        appIosStep2: '“홈 화면에 추가”를 탭하세요',
        appIosStep3: '“추가”를 탭하세요',
        appAndroidTitle: 'Android',
        appAndroidStep1: 'Chrome의 ⋮ 메뉴를 탭하세요',
        appAndroidStep2: '“홈 화면에 추가”를 탭하세요',
        appAndroidStep3: '“추가”를 탭하세요',
        appSectionNote: '도시를 한 번만 정하면 매번 그 도시로 열립니다.',
        nearbyCities: '주변 도시',
