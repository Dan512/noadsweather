...
TRANSLATIONS.it = {
        ...
        settingAlertsMinimized: 'Mostra sempre gli avvisi meteo ridotti',
        ...
        appSectionTitle: 'Un’app meteo senza pubblicità',
        appSectionBody: 'Niente da scaricare. Aggiungi NoAdsWeather alla schermata Home: si apre a schermo intero con la sua icona, senza barra del browser, senza app store, senza account. È lo stesso sito, quindi resta senza pubblicità e senza tracciamento.',
        appIosTitle: 'Su iPhone o iPad',
        appIosStep1: 'Tocca Condividi (il quadrato con la freccia)',
        appIosStep2: 'Tocca «Aggiungi a Home»',
        appIosStep3: 'Tocca Aggiungi',
        appAndroidTitle: 'Su Android',
        appAndroidStep1: 'Tocca il menu ⋮ in Chrome',
        appAndroidStep2: 'Tocca «Aggiungi a schermata Home»',
        appAndroidStep3: 'Tocca Aggiungi',
        appSectionNote: 'Scegli la tua città una volta e si aprirà sempre lì.',
        ...
        // Share card
        share: 'Condividi',
        shareTitle: 'Condividi previsioni',
        share5Day: 'Previsioni a 5 giorni',
        share7Day: 'Previsioni a 7 giorni',
        shareIncludeCurrent: 'Includi condizioni attuali',
        shareIncludePollen: 'Includi polline',
        shareEmoji: 'Aggiungi una reazione',
        shareEmojiNone: 'Nessuna',
        shareCreate: 'Crea immagine',
        shareShareBtn: 'Condividi',
        shareDownload: 'Scarica',
        shareCopyLink: 'Copia link',
        shareLinkCopied: 'Copiato!',
        shareGenerating: 'Creazione immagine...',
        shareFailed: 'Impossibile creare l\'immagine',
        shareShareFailed: 'Impossibile condividere l\'immagine',
        shareCopyFailed: 'Impossibile copiare il link',
        settingShareBtn: 'Mostra pulsante Condividi',
        ...
        hide: 'Nascondi',
        settingShowClimate: 'Mostra le medie climatiche nelle pagine città',
