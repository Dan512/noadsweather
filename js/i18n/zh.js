...
TRANSLATIONS.zh = {
        ...
        cities: '城市',
        popularCities: '热门城市',
        appSectionTitle: '没有广告的天气应用',
        appSectionBody: '无需下载。把 NoAdsWeather 添加到主屏幕，它就会以独立图标全屏打开——没有浏览器地址栏，无需应用商店，无需账号。还是同一个网站，所以依然没有广告、没有跟踪。',
        appIosTitle: 'iPhone 或 iPad',
        appIosStep1: '点按“分享”（带箭头的方框）',
        appIosStep2: '点按“添加到主屏幕”',
        appIosStep3: '点按“添加”',
        appAndroidTitle: 'Android',
        appAndroidStep1: '点按 Chrome 的 ⋮ 菜单',
        appAndroidStep2: '点按“添加到主屏幕”',
        appAndroidStep3: '点按“添加”',
        appSectionNote: '选择一次城市，以后每次都会直接打开。',
        nearbyCities: '附近城市',
        ...
        share5Day: '5天预报',
        share7Day: '7天预报',
        shareIncludeCurrent: '包含当前天气',
        shareIncludePollen: '包含花粉信息',
        shareEmoji: '添加表情反应',
        shareEmojiNone: '无',
        shareCreate: '生成图片',
        shareShareBtn: '分享',
        ...
        shareFailed: '无法生成图片',
        shareShareFailed: '无法分享图片',
        shareCopyFailed: '无法复制链接',
        settingShareBtn: '显示分享按钮',
        ...
        hide: '隐藏',
        settingShowClimate: '在城市页面显示气候平均值',
        notFoundTitle: '页面未找到',
