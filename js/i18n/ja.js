...
TRANSLATIONS.ja = {
        ...
        cities: '都市',
        popularCities: '人気の都市',
        appSectionTitle: '広告なしの天気アプリ',
        appSectionBody: 'ダウンロードは不要です。NoAdsWeather をホーム画面に追加すると、独自のアイコンで全画面表示されます。ブラウザのバーも、アプリストアも、アカウントも必要ありません。同じサイトなので、引き続き広告もトラッキングもありません。',
        appIosTitle: 'iPhone・iPad の場合',
        appIosStep1: '共有ボタン（矢印付きの四角）をタップ',
        appIosStep2: '「ホーム画面に追加」をタップ',
        appIosStep3: '「追加」をタップ',
        appAndroidTitle: 'Android の場合',
        appAndroidStep1: 'Chrome の ⋮ メニューをタップ',
        appAndroidStep2: '「ホーム画面に追加」をタップ',
        appAndroidStep3: '「追加」をタップ',
        appSectionNote: '一度都市を選べば、次からはその都市が開きます。',
        nearbyCities: '近くの都市',
        ...
        share5Day: '5日間予報',
        share7Day: '7日間予報',
        shareIncludeCurrent: '現在の状況を含める',
        shareIncludePollen: '花粉情報を含める',
        shareEmoji: 'リアクションを追加',
        shareEmojiNone: 'なし',
        shareCreate: '画像を作成',
        shareShareBtn: '共有',
        shareDownload: 'ダウンロード',
        shareCopyLink: 'リンクをコピー',
        shareLinkCopied: 'コピーしました！',
        shareGenerating: '画像を作成中...',
        shareFailed: '画像を作成できませんでした',
        shareShareFailed: '画像を共有できませんでした',
        shareCopyFailed: 'リンクをコピーできませんでした',
        settingShareBtn: '共有ボタンを表示',
