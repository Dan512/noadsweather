...
const TRANSLATIONS = {
    en: {
        ...
        appSectionTitle: 'A weather app with no ads',
        appSectionBody: 'Nothing to download. Add NoAdsWeather to your home screen and it opens full-screen with its own icon — no browser bar, no app store, no account. It’s the same site, so there are still no ads and no tracking.',
        appIosTitle: 'On iPhone or iPad',
        appIosStep1: 'Tap Share (the square with the arrow)',
        appIosStep2: 'Tap “Add to Home Screen”',
        appIosStep3: 'Tap Add',
        appAndroidTitle: 'On Android',
        appAndroidStep1: 'Tap the ⋮ menu in Chrome',
        appAndroidStep2: 'Tap “Add to Home screen”',
        appAndroidStep3: 'Tap Add',
        appSectionNote: 'Set your city once and it opens there every time.',
