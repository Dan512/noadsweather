...
TRANSLATIONS.fr = {
        ...
        settingAlertsMinimized: 'Toujours afficher les alertes météo réduites',
        ...
        appSectionTitle: 'Une app météo sans publicité',
        appSectionBody: 'Rien à télécharger. Ajoutez NoAdsWeather à votre écran d’accueil : le site s’ouvre en plein écran avec sa propre icône, sans barre de navigateur, sans magasin d’applications, sans compte. C’est le même site, donc toujours sans publicité ni suivi.',
        appIosTitle: 'Sur iPhone ou iPad',
        appIosStep1: 'Touchez Partager (le carré avec la flèche)',
        appIosStep2: 'Touchez « Sur l’écran d’accueil »',
        appIosStep3: 'Touchez Ajouter',
        appAndroidTitle: 'Sur Android',
        appAndroidStep1: 'Touchez le menu ⋮ dans Chrome',
        appAndroidStep2: 'Touchez « Ajouter à l’écran d’accueil »',
        appAndroidStep3: 'Touchez Ajouter',
        appSectionNote: 'Choisissez votre ville une fois, elle s’ouvrira à chaque fois.',
        ...
        // Share card
        share: 'Partager',
        shareTitle: 'Partager les prévisions',
        share5Day: 'Prévisions sur 5 jours',
        share7Day: 'Prévisions sur 7 jours',
        shareIncludeCurrent: 'Inclure les conditions actuelles',
        shareIncludePollen: 'Inclure le pollen',
        shareEmoji: 'Ajouter une réaction',
        shareEmojiNone: 'Aucune',
        shareCreate: 'Créer l\'image',
        shareShareBtn: 'Partager',
        shareDownload: 'Télécharger',
        shareCopyLink: 'Copier le lien',
        shareLinkCopied: 'Copié !',
        shareGenerating: 'Création de l\'image...',
        shareFailed: 'Impossible de créer l\'image',
        shareShareFailed: 'Impossible de partager l\'image',
        shareCopyFailed: 'Impossible de copier le lien',
        settingShareBtn: 'Afficher le bouton Partager',
