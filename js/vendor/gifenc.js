// gifenc 1.0.3 (https://github.com/mattdesl/gifenc) — MIT, see gifenc-LICENSE.md.
// The npm dist build is CommonJS; this thin IIFE gives it an `exports` object
// and exposes it as window.gifenc for classic-script use (repo has no bundler).
window.gifenc = (function () {
    var exports = {};
    /* ===== begin unmodified gifenc dist/gifenc.js ===== */
