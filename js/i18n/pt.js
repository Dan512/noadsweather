...
TRANSLATIONS.pt = {
        ...
        appSectionTitle: 'Um app de clima sem anúncios',
        appSectionBody: 'Nada para baixar. Adicione o NoAdsWeather à tela de início e ele abre em tela cheia com o próprio ícone — sem barra do navegador, sem loja de aplicativos, sem conta. É o mesmo site, então continua sem anúncios e sem rastreamento.',
        appIosTitle: 'No iPhone ou iPad',
        appIosStep1: 'Toque em Compartilhar (o quadrado com a seta)',
        appIosStep2: 'Toque em “Adicionar à Tela de Início”',
        appIosStep3: 'Toque em Adicionar',
        appAndroidTitle: 'No Android',
        appAndroidStep1: 'Toque no menu ⋮ do Chrome',
        appAndroidStep2: 'Toque em “Adicionar à tela inicial”',
        appAndroidStep3: 'Toque em Adicionar',
        appSectionNote: 'Escolha sua cidade uma vez e ela abre sempre.',
        ...
        // Share card
        share: 'Compartilhar',
        shareTitle: 'Compartilhar previsão',
        share5Day: 'Previsão de 5 dias',
        share7Day: 'Previsão de 7 dias',
        shareIncludeCurrent: 'Incluir condições atuais',
        shareIncludePollen: 'Incluir pólen',
        shareEmoji: 'Adicionar uma reação',
        shareEmojiNone: 'Nenhuma',
        shareCreate: 'Criar imagem',
        shareShareBtn: 'Compartilhar',
        shareDownload: 'Baixar',
        shareCopyLink: 'Copiar link',
        shareLinkCopied: 'Copiado!',
        shareGenerating: 'Criando imagem...',
        shareFailed: 'Não foi possível criar a imagem',
        shareShareFailed: 'Não foi possível compartilhar a imagem',
        shareCopyFailed: 'Não foi possível copiar o link',
        settingShareBtn: 'Mostrar botão de compartilhar',

        refresh: 'Atualizar',
        updatedJustNow: 'Atualizado agora mesmo',
        updatedAgo: 'Atualizado {time}',
        climateHeading: 'Clima em {city}',
        climateMonth: 'Mês',
        climateHigh: 'Máx.',
        climateLow: 'Mín.',
        climatePrecip: 'Precip.',
        climateWetDays: 'Dias de chuva',
